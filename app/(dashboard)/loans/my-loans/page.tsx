...
import { Loader2, Clock, AlertCircle, CheckCircle2, Plus } from "lucide-react"
...
export default function MyLoans() {
  ...
  // Add the missing getLoanStatus function
      ...
      <div className="max-w-screen-2xl mx-auto w-full pb-10 -mt-24">
        <Card className="border-none drop-shadow-sm">
          <CardHeader>
            ...
            <CardDescription>You need to connect your wallet to view your loans</CardDescription>
          </CardHeader>
          <CardContent>
            <Button onClick={connect} className="w-full max-w-md">
              Connect Wallet
            </Button>
          </CardContent>
        </Card>
        ...
        <CardContent>
          {loans.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-[300px] gap-4">
              <p className="text-muted-foreground">You haven't requested any loans yet</p>
              <Button asChild>
                <Link href="/loans/request-loan">Request a Loan</Link>
              </Button>
            </div>
          ) : (
...
function LoanCard({ loan }: { loan: Loan }) {
  ...
  // Define the getLoanStatus function here as well to make it available in this component
